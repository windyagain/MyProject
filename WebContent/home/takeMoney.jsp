...
<form class="form-horizontal" method="post" action="/bishe/card/takeMoney">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      <input type="text" name="money" class="form-control" id="exampleInputAmount" placeholder="请输入取款金额">
