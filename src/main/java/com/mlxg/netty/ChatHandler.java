package com.mlxg.netty;


import com.mlxg.SpringUtil;
import com.mlxg.enums.MsgActionEnum;
import com.mlxg.service.UserService;
import com.mlxg.service.impl.UserServiceImpl;
import com.mlxg.utils.JsonUtils;
...
public class ChatHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, TextWebSocketFrame msg) throws Exception {
        ...
        if(action == MsgActionEnum.CONNECT.type){
            ...
            //测试
            for (Channel c: users) {
                System.out.println("cur channel ----> : " + c.id().asLongText());
            }
