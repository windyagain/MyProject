 ...
 * 发送短信
 */
function sendSms($verifyCode,$telNum) {
    ...
    //阿里云上购买短信服务后，会有这个后下面的一个
        $accessKeyId = "LTAIPc3R3qESCav8";
    $accessKeySecret = "4x5gNpz47zYf4LzjS1Ozgluw80j2gq";

    // fixme 必填: 短信接收号码
    $params["PhoneNumbers"] = $telNum;

    // fixme 必填: 短信签名，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
    $params["SignName"] = "IP视频安全调度管理平台";

    // fixme 必填: 短信模板Code，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
    $params["TemplateCode"] = "SMS_149385783";
...
//error_reporting(0);
     ...
     print_r(sendSms($verifyCode,$telNum));
    $returnJson['Message']= $verifyCode;
